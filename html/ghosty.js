...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'html/ghosty.data';
      var REMOTE_PACKAGE_BASE = 'ghosty.data';
...
Module['FS_createPath']("/", "Assets", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_html/ghosty.data');

      };
      Module['addRunDependency']('datafile_html/ghosty.data');
    ...
    loadPackage({"files": [{"filename": "/Assets/AbilityBall.png", "start": 0, "end": 318}, {"filename": "/Assets/Arrow.png", "start": 318, "end": 559}, {"filename": "/Assets/Hammer.png", "start": 559, "end": 692}, {"filename": "/Assets/Mag.png", "start": 692, "end": 1685}, {"filename": "/Assets/Slime.png", "start": 1685, "end": 2440}, {"filename": "/Assets/Tiles.ase", "start": 2440, "end": 3757}, {"filename": "/Assets/Tiles.png", "start": 3757, "end": 4795}], "remote_package_size": 4795});
...
var ASM_CONSTS = {
  15876: () => { keys = {}; window.addEventListener("keydown", function(event) { keys[event.key.toLowerCase()] = { pressed: true, released: false, held: true }; event.preventDefault(); }); window.addEventListener("keyup", function(event) { keys[event.key.toLowerCase()] = { pressed: false, released: true, held: false }; event.preventDefault(); }); },  
 16212: () => { for (const [key, value] of Object.entries(keys)) { keys[key].pressed = false; keys[key].released = false; } },  
 16320: () => { document.getElementsByTagName("head")[0].innerHTML += "<link href='https://fonts.googleapis.com/css?family=Press Start 2P' rel='stylesheet'>" }
};
